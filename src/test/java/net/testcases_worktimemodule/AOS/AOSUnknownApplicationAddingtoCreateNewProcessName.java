...
public class AOSUnknownApplicationAddingtoCreateNewProcessName extends BaseTest{

	@Parameters("browser")
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Description("Test Description: In This test case we are downloading the excel and validating few data ")
	public void aosUnknownApplicationAddingtoCreateNewProcessName(String browser) throws InterruptedException
	...
	Thread.sleep(1000);
	driver.findElement(By.id("selectType_PN")).click();
