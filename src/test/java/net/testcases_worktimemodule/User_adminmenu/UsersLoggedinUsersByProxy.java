...
public class UsersLoggedinUsersByProxy extends BaseTest{
	...
	@Description("Test Description:Users Show Logged in users by proxy")
	public void usersLoggedinUsersByProxy(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser); 
