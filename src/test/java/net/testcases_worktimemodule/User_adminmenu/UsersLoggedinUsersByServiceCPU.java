...
public class UsersLoggedinUsersByServiceCPU extends BaseTest {
	...
	@Description("Test Description:Users Show Logged in users by ServiceCPU")
	public void usersLoggedinUsersByServiceCPU(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser); 
