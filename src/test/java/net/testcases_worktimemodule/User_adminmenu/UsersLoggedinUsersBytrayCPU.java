...
public class UsersLoggedinUsersBytrayCPU extends BaseTest{
	...
	@Description("Test Description:Users Show Logged in users by bu trayCPU")
	public void usersLoggedinUsersByTrayCPU (String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser); 
