...
public class UsersLoggedinUsersByOSflavour extends BaseTest {
	...
	@Description("Test Description:Users Show Logged in users by OSflavour")
	public void usersLoggedinUsersByOSflavour(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser); 
