...
public class UsersLoggedinUsersByOperatingSystem extends BaseTest {
	...
	@Description("Test Description:Users Show Logged in users by Operating System")
	public void usersLoggedinUsersByOperatingSystem(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser); 
