...
public class UsersLoggedinUsersByHeartbeat extends BaseTest {
	...
	@Description("Test Description:Users Show Logged in users by Heartbeat")
	public void usersLoggedinUsersByHeartbeat(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser); 
