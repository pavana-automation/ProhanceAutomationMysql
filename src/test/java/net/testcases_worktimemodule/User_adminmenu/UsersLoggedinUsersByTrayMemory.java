...
public class UsersLoggedinUsersByTrayMemory extends BaseTest {
	...
	@Description("Test Description:Users Show Logged in users by traymemory")
	public void usersLoggedinUsersByTrayMemory(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser); 
