...
public class ValidateActionViewAuditTrail extends BaseTest

{
	...
	@Parameters("browser")
	public void actionView(String browser) throws InterruptedException, IOException
	{
		launchapp(browser);
		...
		workTimeAuditTrailPage.selectActionChkBx("VIEW");
