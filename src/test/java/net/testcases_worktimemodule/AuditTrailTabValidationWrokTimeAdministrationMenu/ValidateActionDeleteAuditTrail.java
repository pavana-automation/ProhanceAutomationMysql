...
public class ValidateActionDeleteAuditTrail extends BaseTest
{
	...
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class, description = "Audit Trail actionDelete.")
	@Description("Audit Trail actionDelete.")
	@Parameters("browser")
	public void actionDelete(String browser) throws InterruptedException, IOException
	{
		launchapp(browser);
		...
		workTimeAuditTrailPage.selectActionChkBx("DELETE");
