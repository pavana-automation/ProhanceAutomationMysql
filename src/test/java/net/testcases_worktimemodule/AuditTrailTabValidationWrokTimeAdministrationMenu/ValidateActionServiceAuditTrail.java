...
public class ValidateActionServiceAuditTrail extends BaseTest
{
	...
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class, description = "Audit Trail actionService.")
	@Description("Audit Trail actionService.")
	@Parameters("browser")
	public void actionService(String browser) throws InterruptedException, IOException
	{
		...
		workTimeAuditTrailPage.selectActionChkBx("SERVICE");
		...
		aduitWebDataList.clear();
		notExeptedValueList.clear();
		excelDataList.clear();
	}
