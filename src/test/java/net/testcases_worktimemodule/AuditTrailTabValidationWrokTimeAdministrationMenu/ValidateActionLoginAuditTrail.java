...
public class ValidateActionLoginAuditTrail extends BaseTest
{
	...
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class, description = "Audit Trail actionLogin.")
	@Description("Audit Trail actionLogin.")
	@Parameters("browser")
	public void actionLogin(String browser) throws InterruptedException, IOException
	{
		launchapp(browser);
		...
		workTimeAuditTrailPage.selectActionChkBx("LOGIN");
