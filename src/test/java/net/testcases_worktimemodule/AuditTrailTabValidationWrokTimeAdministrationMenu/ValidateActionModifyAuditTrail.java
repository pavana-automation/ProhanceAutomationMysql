...
public class ValidateActionModifyAuditTrail extends BaseTest
{
	...
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class, description = "Audit Trail actionModify.")
	@Description("Audit Trail actionModify.")
	@Parameters("browser")
	public void actionModify(String browser) throws InterruptedException, IOException
	{
		...
		workTimeAuditTrailPage.selectActionChkBx("MODIFY");
