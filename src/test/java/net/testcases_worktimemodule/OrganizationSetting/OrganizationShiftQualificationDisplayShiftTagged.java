...
public class OrganizationShiftQualificationDisplayShiftTagged extends BaseTest {

	// @Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Test
	@Description("Verify whether week day Start is set and saved")
	@Parameters("browser")
	public void organizationShiftQualificationDisplayShiftTagged(String browser) throws InterruptedException {
		launchapp(browser);
		...
		driver.findElement(By.id("continueFromPreviousshift")).click();
