...
public class OrganizationDoNotDisplayNotification extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationDoNotDisplayNotification(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		driver.findElement(By.id("notificationReference")).clear();
		driver.findElement(By.id("notificationReference")).sendKeys("50");
		...
		driver.findElement(By.id("notificationReference")).clear();
		driver.findElement(By.id("notificationReference")).sendKeys("60");
