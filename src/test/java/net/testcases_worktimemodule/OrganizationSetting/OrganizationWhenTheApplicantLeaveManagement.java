...
public class OrganizationWhenTheApplicantLeaveManagement extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationNotRatedLabel(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		driver.findElement(By.id("notRatedLabel")).clear();
		driver.findElement(By.id("notRatedLabel")).sendKeys("Not Rated-test");
		orgPage.clickOnSaveBtn();
		
		Thread.sleep(5000);
		
		String expected = driver.findElement(By.id("notRatedLabel")).getText();
		
		System.out.println("the expected is :" +expected);
		
		driver.findElement(By.id("notRatedLabel")).clear();
		driver.findElement(By.id("notRatedLabel")).sendKeys("Not Rated");
		orgPage.clickOnSaveBtn();
