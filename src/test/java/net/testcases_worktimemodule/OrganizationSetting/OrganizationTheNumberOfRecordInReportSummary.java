...
public class OrganizationTheNumberOfRecordInReportSummary extends BaseTest
{
	...
	public void organizationWhenNoDataIsReported(String browser) throws InterruptedException
	{
		...
		Select select1 = new Select(driver.findElement(By.xpath("//select[@name='reportSummary']")));
		...
		Select select2 = new Select(driver.findElement(By.xpath("//select[@name='reportSummary']")));
