...
public class OrganizationNonWorkShift extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationNonWorkShift(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		String expected = driver.findElement(By.id("defaultworkshift")).getText();
		
		System.out.println("the expected is :" +expected);
		
		driver.findElement(By.id("defaultworkshift")).clear();
		driver.findElement(By.id("defaultworkshift")).sendKeys("Non-Work Shift");
		orgPage.clickOnSaveBtn();
