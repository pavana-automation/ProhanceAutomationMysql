...
public class OrganizationSuperGroupLevel0 extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationSuperGroupLevel0(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		Thread.sleep(1000);
		String exp = driver.findElement(By.id("defaultProductiveHoursLabel")).getText();
		...
		Thread.sleep(5000);
		 ...
		 String act =driver.findElement(By.id("defaultProductiveHoursLabel")).getText();
