...
public class OrganizationShiftQualificationPromptUser extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationShiftQualificationPromptUser(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		WebElement locator = driver.findElement(By.id("promptShiftConfirmation"));
