...
public class OrganizationHeartBeatNotification extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationHeartBeatNotification(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		//driver.findElement(By.id("enableNoHBNotification1")).click();
		
		WebElement locator =  driver.findElement(By.id("enableNoHBNotification1"));
		...
		WebElement locator1 =  driver.findElement(By.id("enableNoHBNotification1"));
