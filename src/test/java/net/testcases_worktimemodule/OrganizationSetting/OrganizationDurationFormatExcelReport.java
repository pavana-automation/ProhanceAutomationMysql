...
public class OrganizationDurationFormatExcelReport extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationDurationFormatExcelReport(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		//Select option1 = new Select(driver.findElement(By.id("exportDurationFormat")));
		//option1.selectByValue("HH");
		
		WebElement locator =  driver.findElement(By.id("exportDurationFormat"));
		...
		//Select option2 = new Select(driver.findElement(By.id("exportDurationFormat")));
		//option1.selectByValue("HH_MM");
