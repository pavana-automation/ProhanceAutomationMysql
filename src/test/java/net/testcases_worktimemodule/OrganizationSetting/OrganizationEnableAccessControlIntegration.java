...
public class OrganizationEnableAccessControlIntegration extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationEnableAccessControlIntegration(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		//driver.findElement(By.id("enableAccessControlPermission1")).click();
		
		WebElement locator =  driver.findElement(By.id("enableAccessControlPermission1"));
		...
		WebElement locator1 =  driver.findElement(By.id("enableAccessControlPermission1"));
