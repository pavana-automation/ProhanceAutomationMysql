...
public class OrganizationShiftQualificationMergeCurrentUserSession extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationShiftQualificationMergeCurrentUserSession(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		driver.findElement(By.id("clientMergeSessionEnable")).click();
