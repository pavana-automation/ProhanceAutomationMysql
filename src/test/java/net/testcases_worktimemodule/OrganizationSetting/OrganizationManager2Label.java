...
public class OrganizationManager2Label extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationManager2Label(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		driver.findElement(By.id("manager2Label")).clear();
		driver.findElement(By.id("manager2Label")).sendKeys("Manager2-test");
		orgPage.clickOnSaveBtn();
		
		Thread.sleep(5000);
		
		String expected = driver.findElement(By.id("manager2Label")).getText();
		
		System.out.println("the expected is :" +expected);
		
		driver.findElement(By.id("manager2Label")).clear();
		driver.findElement(By.id("manager2Label")).sendKeys("Manager2");
		orgPage.clickOnSaveBtn();
