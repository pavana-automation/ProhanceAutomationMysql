...
public class OrganizationShiftQualificationDisplayAllShifts extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationShiftQualificationDisplayAllShifts(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		driver.findElement(By.id("allShifts")).click();
