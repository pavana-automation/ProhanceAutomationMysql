...
public class OrganizationShiftQualificationDisplayBestQualifiedShift extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationShiftQualificationDisplayBestQualifiedShift(String browser) throws InterruptedException
	{
		launchapp(browser);
