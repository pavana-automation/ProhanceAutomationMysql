...
public class OrganizationShiftQualificationDisplayNonWorkShift extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationShiftQualificationDisplayNonWorkShift(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		driver.findElement(By.id("nonWorkShift")).click();
