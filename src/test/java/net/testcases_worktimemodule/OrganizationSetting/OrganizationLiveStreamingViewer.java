...
public class OrganizationLiveStreamingViewer extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationLiveStreamingViewer(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		driver.findElement(By.id("maxUserViewer")).clear();
		driver.findElement(By.id("maxUserViewer")).sendKeys("10");
		...
		String exp =driver.findElement(By.id("maxUserViewer")).getAttribute("value");
		
		Thread.sleep(5000);
		
		driver.findElement(By.id("maxUserViewer")).clear();
		driver.findElement(By.id("maxUserViewer")).sendKeys("20");
		
		orgPage.clickOnSaveBtn();
		
		String act =driver.findElement(By.id("maxUserViewer")).getAttribute("value");
