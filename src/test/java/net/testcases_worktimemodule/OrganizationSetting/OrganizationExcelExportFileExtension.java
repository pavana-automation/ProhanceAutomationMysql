...
public class OrganizationExcelExportFileExtension extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationExcelExportFileExtension(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		//WebElement radio1 = driver.findElement(By.id("xlsxRadio"));
		//radio1.click();
		
		WebElement locator =  driver.findElement(By.id("xlsxRadio"));
		...
		//WebElement radio2 = driver.findElement(By.id("xlsRadio"));
		//radio1.click();
		
		WebElement locator1 =  driver.findElement(By.id("xlsRadio"));
