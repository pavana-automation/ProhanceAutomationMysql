...
public class OrganizationShiftQualificationComputeSessionDateBased extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationShiftQualificationComputeSessionDateBased(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		driver.findElement(By.id("enableClientTimeZone")).click();
