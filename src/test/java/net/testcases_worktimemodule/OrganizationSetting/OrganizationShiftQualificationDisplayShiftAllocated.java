...
public class OrganizationShiftQualificationDisplayShiftAllocated extends BaseTest
{
	...
	@Parameters("browser")
	public void organizationShiftQualificationDisplayShiftAllocated(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		driver.findElement(By.id("fromShiftRoster")).click();
