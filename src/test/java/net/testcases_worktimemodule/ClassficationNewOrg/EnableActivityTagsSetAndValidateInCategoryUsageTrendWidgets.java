...
public class EnableActivityTagsSetAndValidateInCategoryUsageTrendWidgets extends BaseTest
{
	...
	@Parameters("browser")
	public void addActivityTagInCaficationAndValidateInWidget(String browser) throws InterruptedException, IOException
	{
		launchapp(browser);	
		...
		wrokTimeActivityDashboardPage.selectWidget("Category Usage Trend");
		wrokTimeActivityDashboardPage.clickWidgetFilterBtn();
		wrokTimeActivityDashboardPage.selectingFiltersInCategoryUsageTrendWidget(perpareMapFilterValues());
