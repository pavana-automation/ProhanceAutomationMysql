...
public class UserRolesModifyManagerEditTimeSheet extends BaseTest{

	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Parameters("browser")
	@Description("Test Description: USerRole verifying whether Activity Rating")
	public void userRolesModifyManagerEditTimeSheet(String browser) throws InterruptedException
	{
