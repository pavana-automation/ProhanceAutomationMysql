...
public class UserRolesModifyManagerEditCurrentActivity extends BaseTest{

	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Parameters("browser")
	@Description("Test Description: USerRole verifying whether Activity Rating")
	public void userRolesModifyManagerEditCurrentActivity(String browser) throws InterruptedException
	{
		launchapp(browser);
		//WebDriver driver;
		...
		userRole.selectCurrentActivity();
