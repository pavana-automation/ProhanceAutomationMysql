...
public class UserRolesModifyManagerEditAttendence extends BaseTest{

	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Parameters("browser")
	@Description("Test Description: USerRole verifying whether Activity Rating")
	public void userRolesModifyManagerEditAttendence(String browser) throws InterruptedException
	{
