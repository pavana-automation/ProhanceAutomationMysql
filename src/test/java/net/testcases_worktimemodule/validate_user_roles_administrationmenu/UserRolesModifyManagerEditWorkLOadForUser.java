...
public class UserRolesModifyManagerEditWorkLOadForUser extends BaseTest{

	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Parameters("browser")
	@Description("Test Description: USerRole verifying whether Activity Rating")
	public void userRolesModifyManagerEditWorkLOadForUser(String browser) throws InterruptedException
	{
		...
		if(driver.findElement(By.xpath("//input[@id='chk_level3_R_0']")).isSelected())
		{
				driver.findElement(By.xpath("//*[@id='tab_table']/tbody/tr[1]/td/span[2]")).click();
		}
		else {
			driver.findElement(By.xpath("//input[@id='chk_level3_R_0']")).click();
			driver.findElement(By.xpath("//*[@id='tab_table']/tbody/tr[1]/td/span[2]")).click();
			}
		...
		Assert.assertTrue(driver.findElement(By.xpath("//input[@id='chk_level3_R_0']")).isSelected());
