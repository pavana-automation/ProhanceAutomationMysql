...
public class UserRolesBulkUpdateMember extends BaseTest{
	...
	@Parameters("browser")
	@Description("Test Description: Here we are verifying the bulk update done in user role member ")
	public void userRolesBulkUpdateMember(String browser) throws InterruptedException
	{
		launchapp(browser);
