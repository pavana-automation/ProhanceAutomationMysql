...
public class UserRolesModifyManagerRestrictusers extends BaseTest{
	...
	@Parameters("browser")
	@Description("Test Description: Here we are verifying whether we are able to modify and manager")
	public void userRolesModifyManagerRestrictusers(String browser) throws InterruptedException
	{
		 ...
		 * GenderalVariables.JTSaleManagerPassword); Set<String> url =
		 * driver.getWindowHandles(); System.out.println("the  url is :"+url);
		 * 
		 * 
