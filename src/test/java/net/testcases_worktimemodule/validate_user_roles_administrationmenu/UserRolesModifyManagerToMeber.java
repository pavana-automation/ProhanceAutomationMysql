...
public class UserRolesModifyManagerToMeber extends BaseTest{
	
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Parameters("browser")
	@Description("Test Description: Here we are verifying whether we are able to modify ")
	public void userRolesModifyManagerToMeber(String browser) throws InterruptedException
	{
		launchapp(browser);
		...
		Assert.assertEquals("Member", actual1);
