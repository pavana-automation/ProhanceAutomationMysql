...
public class UserRolesModifyManagerEditCustomReportsPublishReport extends BaseTest{

	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Parameters("browser")
	@Description("Test Description: USerRole verifying whether Activity Rating")
	public void userRolesModifyManagerEditCustomReportsPublishReport(String browser) throws InterruptedException
	{
		...
		if(driver.findElement(By.xpath("//input[@id='allowToPublishCustomReport']")).isSelected())
		{
				driver.findElement(By.xpath("//*[@id='tab_table']/tbody/tr[1]/td/span[2]")).click();
		}
		else {
			driver.findElement(By.xpath("//input[@id='allowToPublishCustomReport']")).click();
			driver.findElement(By.xpath("//*[@id='tab_table']/tbody/tr[1]/td/span[2]")).click();
			}
		...
		Assert.assertTrue(driver.findElement(By.xpath("//input[@id='allowToPublishCustomReport']")).isSelected());
	}
