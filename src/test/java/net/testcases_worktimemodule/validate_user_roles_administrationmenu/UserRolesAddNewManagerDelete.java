...
public class UserRolesAddNewManagerDelete extends BaseTest {
	...
	@Parameters("browser")
	@Description("Test Description: Here we are verifying the delete functianality in user role : Manager ")
	public void userRolesAddNewManagerDelete(String browser) throws InterruptedException
	{
		launchapp(browser);
