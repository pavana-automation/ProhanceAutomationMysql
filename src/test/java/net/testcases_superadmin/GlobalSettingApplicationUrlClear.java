...
public class GlobalSettingApplicationUrlClear extends BaseTest{
	
	@Parameters("browser")
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Description("Test Description: Global Settings Application URL clear validation")
	public void globalSettingApplicationUrlClear(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser); 
