...
public class GlobalSettingCoreServiceForGoalNotificationRange extends BaseTest{
	
	@Parameters("browser")
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Description("Test Description: Global Settings Core service for Goal notification validation")
	public void globalSettingCoreServiceForGoalNotificationRange(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		...
		setting.clickNoOfThreadsGoalEvaluation("1");
		
		setting.clickSaveBtn();
		Thread.sleep(1000);
		
		setting.clickGoalEvalRange();
		
		setting.clickOKbtn();
		
		setting.clickNoOfThreadsGoalEvaluation("99");
