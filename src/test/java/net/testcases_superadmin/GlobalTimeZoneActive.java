...
public class GlobalTimeZoneActive extends BaseTest{
	...
	public void globalTimeZoneActive(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		...
		if(time.getActiveTimeZoneCount() > 0)
		{
			
			System.out.println("Check");
			time.clickOnActivetimeZone();
			
			//time.clickActivedMsg();
		}
		/*
		 * else { //listeners.testStepDescription("Step 6: No Active Time Zone ");
		 * System.out.println("No Active Time Zone"); } //listeners.
