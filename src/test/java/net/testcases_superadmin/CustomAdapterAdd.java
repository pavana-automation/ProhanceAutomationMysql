...
public class CustomAdapterAdd extends BaseTest{
	
	@Parameters("browser")
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Description("Test Description: Custom Adapter add")
	public void customAdapterAdd(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser);
		...
		adapter.clickCustomDate("22Apr2024");
		Thread.sleep(2000);
