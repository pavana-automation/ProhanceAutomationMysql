...
public class GlobalSettingsClientsClearBtn extends BaseTest{
	@Parameters("browser")
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Description("Test Description: Global Settings clients clear validation")
	public void globalSettingsClientsClearBtn(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser); 
