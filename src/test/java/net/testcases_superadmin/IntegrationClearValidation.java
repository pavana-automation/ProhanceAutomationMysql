...
public class IntegrationClearValidation  extends BaseTest{
	
	@Parameters("browser")
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Description("Test Description:Integration clear validation")
	public void integrationClearValidation(String browser) throws Exception {
