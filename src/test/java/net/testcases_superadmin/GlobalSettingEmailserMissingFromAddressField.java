...
public class GlobalSettingEmailserMissingFromAddressField extends BaseTest{
	@Parameters("browser")
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Description("Test Description: Global Settings Application URL clear validation")
	public void globalSettingEmailserMissingFromAddressField(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser); 
		...
		setting.clickFromAddress("");
		
		setting.clickSaveBtn();
		Thread.sleep(1000);
		
		setting.clickFromAddressRequired();
	}
}