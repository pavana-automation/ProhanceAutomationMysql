...
public class GlobalSettingCoreServicesClear extends BaseTest{
	@Parameters("browser")
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Description("Test Description: Global Settings Core serviceclear validation")
	public void globalSettingCoreServicesClear(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser); 
