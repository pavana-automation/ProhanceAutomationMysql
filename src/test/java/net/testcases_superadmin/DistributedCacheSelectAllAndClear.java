...
public class DistributedCacheSelectAllAndClear extends BaseTest{

	@Parameters("browser")
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Description("Test Description: Distribution cache selecting all and clearing all")
	public void distributedCacheSelectAllAndClear(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		launchapp(browser);
