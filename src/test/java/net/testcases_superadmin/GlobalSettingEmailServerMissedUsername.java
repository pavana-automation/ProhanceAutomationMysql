...
public class GlobalSettingEmailServerMissedUsername extends BaseTest{
	@Parameters("browser")
	@Test(retryAnalyzer = net.Commons.RetryAnalyzer.class)
	@Description("Test Description: Global Email server with missed username validation")
	public void globalSettingsEmailServerSave(String browser) throws InterruptedException, EncryptedDocumentException, IOException {
		...
		setting.clickUserName("");
		
		setting.clickSaveBtn();
		Thread.sleep(1000);
		
		setting.clickUsernameRequired();
	}
}